...
For further background and details on using `sherlock`, see the package vignette.
For an overview of the underlying statistical methodology, see our [conference
manuscript](https://arxiv.org/abs/2111.01223) [@hejazi2021framework] from
[CODE @ MIT 2021](https://ide.mit.edu/events/2021-conference-on-digital-experimentation-mit-codemit/).
